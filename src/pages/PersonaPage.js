          ...
          <div className="persona-left">
            <Card>
              <div className="persona-card-header">
                ...
                {locked && <span className="lock-icon"><Icon name="lock" size={12} /> Locked</span>}
              </div>
              ...
              <div className="persona-actions">
                ...
                <button className="btn-ghost" onClick={handleLock}>
                  {locked ? <><Icon name="unlock" size={14} /> Unlock Persona</> : <><Icon name="lock" size={14} /> Lock Persona</>}
                </button>
              </div>
              ...
              <div className="persona-llm-note">
                ...
                >
                  {generating ? (
                    ...
                    <><Icon name="sparkles" size={14} /> Generate Persona with Gemini</>
                  )}
                </button>
